...
This is an introductory project on SQL data definitions and data manipulation language, making subqueries, and using functions. In this project, we worked moslty on relational database.

There are a total of 21 tasks in this project:
17 mandatory and 4 advanced tasks.
